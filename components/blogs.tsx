  ...
  return (
    ...
    >
      <Flex direction='column'>
        <Img objectFit='cover' alt={title} src={media} style={{height:"28rem"}}/>
        <Flex direction='column' px={{ sm: '6' }} py='5'>
          ...
          >
            <Text>
              By{' '}
              <Box as='a' textDecor='underline' href={href}>
                {author}
              </Box>
            </Text>
            <Link href='#'>
    ...
    [
      {
        ...
        title:'7 Steps to Get Professional Productivity Tips while working from Home',
